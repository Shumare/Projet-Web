...
class Company_detailsController extends Controller 
{
    public function index()
    {
     ...
     public function read(int $id )
     {
         ...
         $intern_rating = $intern_rating->findBy(['id_company'=>$id]);
         //on envoie à la vue 
         $this->rendu(array('Company_details/read','intern_Rating/read'),array_merge(compact('Company_details'),compact('intern_rating')) );
     }
